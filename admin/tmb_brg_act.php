...
$sql = mysqli_query($conn, "INSERT INTO `barang` (`id`, `nama`, `jenis`, `suplier`, `modal`, `harga`, `jumlah`, `sisa`, `foto`) VALUES (NULL, '$nama','$jenis','$suplier','$modal','$harga','$jumlah','$sisa','$foto')");
if ($sql) {
